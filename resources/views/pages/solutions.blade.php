        ...
        <section class="max-w-[1440px] mx-auto px-6 md:px-[64px] lg:px-[96px] py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div class="relative z-10 max-w-[610px]">
                ...
                <h1 class="font-space font-bold text-[48px] md:text-[72px] leading-[1.1] md:leading-[94px] tracking-[-1.8px] text-dark mb-6">
                    Build a robust <br>
                    <span class="text-primary">digital foundation.</span>
                </h1>
                
                <p class="text-[18px] md:text-[20px] text-gray-body leading-[33px] font-space mb-10 max-w-[610px]">
                    ATS provides end-to-end technology infrastructure solutions designed to scale with your business. From secure networks to smart environments, we engineer reliability.
                </p>
            ...
            <div class="relative w-full max-w-[624px] ml-auto mt-12 lg:mt-0">
                ...
                <div class="relative z-10 aspect-square border border-gray-border/50 rounded-[16px] overflow-hidden shadow-2xl bg-white">
                    <img src="{{ asset('assets/images/downloaded/photo_1558494949_ef010cbdcc31.jpg') }}" alt="Server Data Center" class="w-full h-full object-cover">
                </div>
        ...
        <section class="bg-gray-light py-24 px-6 md:px-[64px] lg:px-[96px]">
            <div class="max-w-[1440px] mx-auto">
                <div class="text-center mb-16">
                    <h2 class="font-space font-bold text-[36px] leading-[40px] text-dark mb-4">Core Capability Areas</h2>
                    <p class="text-[18px] text-gray-body leading-[28px] max-w-[703px] mx-auto">
                        We deliver tailored solutions across four primary domains, ensuring your organization is secure, connected, and optimized for the future.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-[10px] p-6 flex flex-col box-shadow custom-hover-lift hover:shadow-lg transition-shadow border border-gray-border/30">
                        <div class="w-[56px] h-[56px] bg-red-muted rounded-xl flex items-center justify-center mb-6 shrink-0">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#E21D2E" stroke-width="1.5"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>
                        </div>
                        ...
                        <a href="{{ url('contact') }}" class="inline-flex items-center text-[14px] font-medium text-primary hover:text-[#C4182A] group">
                            Explore Solution
                    ...
                    <div class="bg-white rounded-[10px] p-6 flex flex-col box-shadow custom-hover-lift hover:shadow-lg transition-shadow border border-gray-border/30">
                        <div class="w-[56px] h-[56px] bg-blue-light rounded-xl flex items-center justify-center mb-6 shrink-0">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#365EE2" stroke-width="1.5"><path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><line x1="12" y1="20" x2="12.01" y2="20"/></svg>
                        </div>
                    ...
                    <div class="bg-white rounded-[10px] p-6 flex flex-col box-shadow custom-hover-lift hover:shadow-lg transition-shadow border border-gray-border/30">
                        ...
                        <a href="{{ route('contact') }}" class="inline-flex items-center text-[14px] font-medium text-primary hover:text-[#C4182A] group">
                            Explore Solution
                            <svg class="ml-1 w-4 h-4 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                        </a>
                    </div>
        ...
        <section class="max-w-[1440px] mx-auto px-6 md:px-[64px] lg:px-[96px] py-24 bg-white">
            ...
            <div class="border-b border-gray-border pb-12 mb-12 flex flex-col md:flex-row md:justify-between md:items-center gap-8">
                <div class="max-w-[760px]">
                    ...
                    <h2 class="font-space font-bold text-[36px] md:text-[48px] leading-[1] text-dark mb-6">Enterprise Network Architecture</h2>
                    <p class="font-space text-[18px] md:text-[20px] leading-[28px] text-gray-body">
                        A comprehensive approach to building a resilient, high-capacity corporate network capable of supporting demanding modern workloads and distributed teams.
                    </p>
                </div>
                <div class="shrink-0">
                ...
                <div class="lg:col-span-8 flex flex-col">
                    ...
                    <div class="w-full bg-gray-light rounded-[16px] overflow-hidden mb-12">
                        ...
                        <div class="w-full h-[400px] bg-dark relative flex items-center justify-center overflow-hidden">
                            ...
                            <div class="absolute inset-0 bg-blue-primary/10"></div>
                            <img src="{{ asset('assets/images/downloaded/photo_1451187580459_43490279c0fa.jpg') }}" alt="Network Nodes Background" class="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50">
                        </div>
                    </div>
                ...
                <div class="lg:col-span-4 flex flex-col gap-6">
                    ...
                    <div class="border border-gray-border rounded-[10px] bg-white overflow-hidden shadow-sm">
                        ...
                        <div class="flex flex-col">
                            ...
                            <!-- Item 1 -->
                            <a href="{{ route('contact') }}" class="p-4 flex items-center gap-4 hover:bg-gray-50 transition-colors border-b border-gray-border/50 group">
                                <!-- Fake Product Image -->
                                <div class="w-16 h-16 border border-gray-border rounded bg-white overflow-hidden shrink-0">
                                    <img src="{{ asset('assets/images/downloaded/photo_1544197150_b99a580bb7a8.jpg') }}" alt="Cisco Switch" class="w-full h-full object-cover">
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-[12px] text-gray-body mb-0.5">Core Switch</div>
                                    <div class="font-bold text-[14px] text-dark truncate">Cisco Catalyst 9300 Series</div>
                                    <div class="font-medium text-[14px] text-dark mt-0.5">EGP 124,500</div>
                                </div>
                            ...
                            <!-- Item 3 -->
                            <a href="{{ url('contact') }}" class="p-4 flex items-center gap-4 hover:bg-gray-50 transition-colors border-b border-gray-border group">
                                <div class="w-16 h-16 border border-gray-border rounded bg-white overflow-hidden shrink-0">
