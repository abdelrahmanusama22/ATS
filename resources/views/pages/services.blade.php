...
@section('content')
    <main class="max-w-[1440px] mx-auto pb-24 px-6 md:px-[64px] lg:px-[96px]">
            ...
            <div class="relative z-10 w-full grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p class="text-[16px] md:text-[20px] text-white/80 leading-[28px] max-w-[499px] mb-10">
                        From robust network installations to proactive 24/7 managed support, ATS delivers premium technology services designed to scale your business securely and efficiently.
                    </p>
                ...
                <div class="flex justify-end hidden md:flex">
                    <div class="w-full max-w-[448px] aspect-[16/9] border border-white/10 rounded-[24px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                        <img src="{{ asset('assets/images/downloaded/photo_1551434678_e076c223a692.jpg') }}" alt="Engineer in server room" class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="mb-12" id="pricing">
            <h2 class="font-space font-bold text-[30px] leading-[36px] tracking-[-0.75px] text-dark mb-3">Comprehensive Service Catalog</h2>
            <p class="text-[18px] text-gray-body leading-[28px] max-w-[770px]">
                Explore our core service offerings. Each solution is tailored to your specific operational requirements and budget constraints.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-6 mb-24">
            ...
            <div class="bg-white border border-gray-border rounded-[16px] overflow-hidden flex flex-col box-shadow custom-hover-lift hover:shadow-lg transition-all duration-300">
                ...
                <div class="bg-gray-light/30 border-b border-gray-border/50 p-6 md:p-8 relative">
                    <div class="flex gap-4 items-center">
                        ...
                        <div>
                            <h3 class="font-space font-bold text-[24px] text-dark">Network Installation</h3>
                            <p class="text-[14px] text-gray-body mt-1 max-w-[440px]">Robust and scalable network infrastructure tailored for high-density corporate environments.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8 flex-1 flex flex-col">
                    ...
                    <p class="text-[14px] text-gray-body leading-[23px] mb-6">
                        We begin with a comprehensive site survey and RF mapping, followed by meticulous structural cabling and enterprise-grade hardware deployment to ensure zero dead-zones and maximum throughput.
                    </p>
                    ...
                    <div class="bg-gray-light border border-gray-border/50 rounded-[10px] p-5 mt-auto">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6">
                            <div class="flex items-start gap-2">
                                ...
                                <span class="text-[14px] text-dark/90 leading-[20px]">Structured Cabling (Cat6a/Fiber)</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E21D2E" stroke-width="2" class="mt-0.5 shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                <span class="text-[14px] text-dark/90 leading-[20px]">Enterprise Wi-Fi 6/6E Deployment</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E21D2E" stroke-width="2" class="mt-0.5 shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                <span class="text-[14px] text-dark/90 leading-[20px]">Core & Edge Switch Configuration</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E21D2E" stroke-width="2" class="mt-0.5 shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                <span class="text-[14px] text-dark/90 leading-[20px]">Network Segmentation & VLANs</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Service Card 2 -->
            <div class="bg-white border border-gray-border rounded-[16px] overflow-hidden flex flex-col box-shadow custom-hover-lift hover:shadow-lg transition-all duration-300 relative">
                
                <!-- Tag Most Popular -->
                <div class="absolute top-8 right-8 bg-primary rounded-full px-3 py-1 flex items-center justify-center z-10">
                    <span class="font-medium text-[12px] text-white leading-none">Most Popular</span>
                </div>
        ...
        <section class="bg-gray-light border border-gray-border rounded-[16px] py-16 px-6 relative mb-24 text-center">
            <h2 class="font-space font-bold text-[30px] leading-[36px] tracking-[-0.75px] text-dark mb-4">The ATS Methodology</h2>
            <p class="text-[18px] text-gray-body leading-[28px] max-w-[651px] mx-auto mb-20">
                We don't just fix problems; we engineer solutions. Our proven three-step process ensures your IT investments align perfectly with your business goals.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative max-w-[1000px] mx-auto">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="font-space font-bold text-[20px] mb-3 leading-[28px]">1. Discovery & Audit</h3>
                    <p class="text-[14px] text-gray-body leading-[20px] max-w-[230px]">We analyze your current infrastructure, identify bottlenecks, and define your operational goals.</p>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="font-space font-bold text-[20px] mb-3 leading-[28px]">2. Strategy & Design</h3>
                    <p class="text-[14px] text-gray-body leading-[20px] max-w-[236px]">Our architects draft a tailored, scalable solution focusing on efficiency and high ROI.</p>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="font-space font-bold text-[20px] mb-3 leading-[28px]">3. Deployment & Support</h3>
                    <p class="text-[14px] text-gray-body leading-[20px] max-w-[227px]">Seamless implementation followed by rigorous testing and ongoing proactive maintenance.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white border border-gray-border rounded-[16px] py-16 px-6 text-center max-w-[1248px] mx-auto box-shadow relative overflow-hidden">
            <div class="flex flex-col items-center">
                ...
                <h2 class="font-space font-bold text-[30px] leading-[36px] text-dark max-w-[565px] mb-4">Ready to upgrade your infrastructure?</h2>
                <p class="text-[18px] text-gray-body leading-[28px] max-w-[533px] mb-8">
                    Speak directly with one of our senior solutions architects to discuss your specific requirements and get a preliminary estimate.
                </p>
